...
namespace MonsterTCG
{
    ...
    public static class ListMaster
    {
        ...
        public enum Species {Goblin, Wizzard, Ork, Knight, WaterSpell, Kraken, FireElves, Dragon, none } //should i put none as a value or just leave it empty?i think the none optinon is better.

        public static List<Card> AllCards = new List<Card> //to be done in db
        {
        new MonsterCard("name",34,Type.Fire,Species.none), //debug feature
